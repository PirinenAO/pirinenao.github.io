...
const prompt1text = document.getElementById("launch");
const prompt2text = document.getElementById("launch2");
...
function main() {
  if (counter === 0) {
    typeToPrompt(0, text1, prompt1text, 50);
  } else if (counter === 1) {
    showPromtLine();
    setTimeout(() => typeToPrompt(0, text2, prompt2text, 50), 2000);
  } else if (counter === 2) {
